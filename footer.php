  ...
  <div class="container">
    <div class="row gy-4">
      ...
      <div class="col-lg-3 col-md-12 footer-contact text-center text-md-start">
        <h4>Contact Us</h4>
        <p>
          Magura Daspara Street <br>
          Khulna,Satkhira 9400<br>
          Bangldesh <br><br>
          <strong>Phone:</strong> +8801927166288<br>
          <strong>Email:</strong> cse.palashdas@gmail.com<br>
        </p>
...
<div class="container">
  <div class="copyright">
    &copy; Copyright <strong><span>Palash</span></strong>. All Rights Reserved
  </div>
  <div class="credits">
    
    Designed by <a href="#">Palash Kumar Das</a>
  </div>
</div>
</footer><!-- End Footer -->
